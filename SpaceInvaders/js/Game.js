...
class Game {
    ...
    start() {
        ...
        <font style=" margin-left: 680px;"><font style="color: #868a8d; margin-right: 20px;" id="countPoints" class="header-font">000</font><img src="images/live.png" width="30" height="20" style="margin-top: -7px;"> <font style="color: #868a8d;" id="countLives" class="header-font">3</font> </font>
        </div>`);
